<?php
$nik    = $_GET['nik'];
$query = mysqli_query($koneksi, "SELECT * FROM datapasien AS a
LEFT JOIN datapuskesmas AS b ON a.puskesmas=b.id WHERE nik='$nik'");
            ...
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="puskesmas">
                  <option class="form-control" value="<?php echo $view['puskesmas']; ?>"><?php echo $view['namapuskesmas']; ?></option>
                  <?php
